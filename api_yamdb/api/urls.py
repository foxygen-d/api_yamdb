...
from .views import (
    CategoriesViewSet, GenresViewSet, ProfileUpdateView, ReviewViewSet,
    CommentsViewSet, SignUpView, TitlesViewSet, TokenObtainAccessView,
    UsersViewSet)
...
urlpatterns = [
    path('v1/users/me/', ProfileUpdateView.as_view()),
